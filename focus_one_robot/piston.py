...
class Joint1Controller(Node):
    def __init__(self):
        super().__init__('joint_6_controller')

        # Publisher to send "done" feedback
        self.feedback_publisher = self.create_publisher(String, 'joint_6_feedback', 10)
        ...
        self.get_logger().info("piston Controller Node Initialized")
