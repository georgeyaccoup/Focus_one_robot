...
class Joint1Controller(Node):
    def __init__(self):
        super().__init__('joint_4_controller')

        # Publisher to send "done" feedback
        self.feedback_publisher = self.create_publisher(String, 'joint_4_feedback', 10)
        ...
        self.get_logger().info("Joint 4 Controller Node Initialized")
