...
class Joint1Controller(Node):
    def __init__(self):
        super().__init__('joint_1_controller')

        # Publisher to send "done" feedback
        self.feedback_publisher = self.create_publisher(String, 'joint_1_feedback', 10)
        ...
        self.get_logger().info("Joint 1 Controller Node Initialized")
